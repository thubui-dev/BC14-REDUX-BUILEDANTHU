...
import { actCancel } from "../redux/action/indexBooking";
        ...
        <div className="mt-5">
          <table className="table" border="2">
            ...
            <tbody className="text-warning" style={{ fontSize: "20px" }}>
              {this.props.bookingList.map((gheDangDat, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td>
                      <button
                        onClick={() => {
                          this.props.cancelBooking(gheDangDat.soGhe);
                        }}
                      >
                        Hủy
                      </button>
            ...
            <tfoot>
              <tr className="text-warning" style={{ fontSize: "25px" }}>
                <td></td>
                <td>Tổng tiền</td>
                <td>{this.props.bookingList.reduce((tongTien, gheDangDat, index) => {
